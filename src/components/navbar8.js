        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            <a href={props.link2Url} className="thq-link thq-body-small">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text13">#about</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text15">#gallery</span>
                </Fragment>
              )}
            </a>
            <div
                      ...
                      <div className="navbar8-menu-item1">
                        ...
                        <div className="navbar8-content1">
                          <span className="navbar8-page11 thq-body-large">
                            {props.page1 ?? (
                              <Fragment>
                                <span className="navbar8-text12">Home</span>
                              </Fragment>
                            )}
                          </span>
                      ...
                      <div className="navbar8-menu-item3">
                        ...
                        <div className="navbar8-content3">
                          <span className="navbar8-page31 thq-body-large">
                            {props.page3 ?? (
                              <Fragment>
                                <span className="navbar8-text23">Gallery</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                ...
                <div className="navbar8-menu-item6">
                  ...
                  <div className="navbar8-content6">
                    ...
                    <span className="thq-body-small">
                      {props.page2Description ?? (
                        <Fragment>
                          <span className="navbar8-text21">Meet the Owner</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
                ...
                <div className="navbar8-menu-item8">
                  ...
                  <div className="navbar8-content8">
                    ...
                    <span className="thq-body-small">
                      {props.page4Description ?? (
                        <Fragment>
                          <span className="navbar8-text18">Get in Touch</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
...
Navbar8.defaultProps = {
  page2ImageAlt: 'Image of Cafe Owner',
  logoAlt: 'Basque Cheese Cake Cafe Logo',
  page1: undefined,
  link2: undefined,
  page3ImageAlt: 'Image of Cheese Cake Varieties',
  link1: undefined,
  logoSrc:
  ...
  page4ImageAlt: 'Image of Contact Information',
  ...
  page3: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1639665047213-d2b6eb288dc8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1ODcxNDk1OHw&ixlib=rb-4.1.0&q=80&w=1080',
  page2ImageSrc:
  ...
  page4: undefined,
  page1ImageAlt: 'Image of Basque Cheese Cake',
  action1: undefined,
}
