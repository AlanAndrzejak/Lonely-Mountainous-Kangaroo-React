                ...
                {props.feature1Title ?? (
                  <Fragment>
                    <span className="features24-text4">
                      Irresistible Basque Cheese Cake
                    </span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.feature1Description ?? (
                  <Fragment>
                    <span className="features24-text2">
                      Welcome to the world of heavenly Basque cheese cakes at
                      our cafe.
                    </span>
                  </Fragment>
                )}
                ...
                {props.feature2Description ?? (
                  <Fragment>
                    <span className="features24-text3">
                      Indulge in the creamy texture and rich flavor of our
                      signature Basque cheese cake.
                    </span>
                  </Fragment>
                )}
              </span>
...
Features24.defaultProps = {
  ...
  feature2ImgAlt: 'Creamy Basque Cheese Cake',
  feature3ImgAlt: 'Authentic Basque Recipe',
  feature1ImgSrc:
  ...
  feature1ImgAlt: 'Basque Cheese Cake Cafe',
  feature2ImgSrc:
